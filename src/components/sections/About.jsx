...
export const About = () => {
  ...
  const tools = ["Git", "Github", "Docker", "Postman", "VS Code", "npm"];
    ...
    >
      <RevealOnScroll>
        <div className="max-w-3xl mx-auto px-4">
          ...
          {/* <div className=" mx-a grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="w-full p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              <h3 className="text-xl font-bold mb-4"> 🏫 Education </h3>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>
                  <strong> Btech in Information Technology </strong> - GGSIPU
